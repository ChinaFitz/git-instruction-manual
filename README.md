...
- [Git使用说明书(学习笔记)](#git使用说明书学习笔记)
  ...
  - [git分支](#git分支)
    - [合并分支(merge、rebase)](#合并分支merge-rebase)
  ...
  - [git时光机](#git时光机)
    ...
    - [git reset --hard回退版本库、暂存区、工作区](#git-reset-hard回退版本库-暂存区-工作区)
    - [git revert回退版本库、暂存区、工作区(常用于远程仓库的回退)](#git-revert回退版本库-暂存区-工作区常用于远程仓库的回退)
    - [总结分支切换、reset时光机、路径reset所操作的区域与指针对象](#总结分支切换-reset时光机-路径reset所操作的区域与指针对象)
